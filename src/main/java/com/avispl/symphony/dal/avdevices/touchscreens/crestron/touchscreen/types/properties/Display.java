...
public enum Display implements BaseProperty {
	...
	LCD_STANDBY_TIMEOUT_VALUE(Constant.LCD_DISPLAY_GROUP + "StandbyTimeoutCurrentValue"),
	//	Audio
	...
	BUTTON_TOOLBAR_AUTO_HIDE_TIMEOUT_VALUE(Constant.BUTTON_TOOLBAR_DISPLAY_GROUP + "AutoHideTimeoutCurrentValue");
